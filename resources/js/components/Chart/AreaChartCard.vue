<template>
    <div class="card">
        <div class="card-body">
            <apexchart height="245" type="area" :options="procChartOpts" :series="procNewSeriesValues"></apexchart>
        </div>
        ...
        newReading: {
            handler(newVal) {
                ...
                if (this.seriesValues[0].data.length < this.xAxis.length) {
                    ...
                    if (this.seriesValues[0].data.length >= 18)
                        this.seriesValues[0].data.shift();
                    if (this.seriesValues[1].data.length >= 18)
